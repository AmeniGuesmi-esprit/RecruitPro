# -*- coding: utf-8 -*-
"""
Génère un dataset synthétique de 10 000 lignes (candidat x offre) couvrant
...
Chaque ligne contient :
  ...
  - un score de matching "vérité terrain" (0-100) calculé à partir des
    VRAIES compétences/expérience du candidat (pas celles ré-extraites),
    pour simuler l'évaluation d'un recruteur humain.
...
def generate_row(row_id):
    ...
    # domaine différent (négatif clair), pour que le modèle apprenne aussi les
    # mauvais matchs.
...
def main():
    ...
    parser.add_argument("--out", type=str, default="data/cv_job_matching_dataset.csv")
